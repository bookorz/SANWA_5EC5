...
namespace Rorze.SECS.Driver
{
    public sealed class SecsMessage
    {
        ...
        internal Lazy<List<ArraySegment<byte>>> RawDatas;

        //public IReadOnlyList<ArraySegment<byte>> RawBytes => RawDatas.Value.AsReadOnly();
        internal IList<ArraySegment<byte>> RawBytes => RawDatas.Value.AsReadOnly();

        // private static readonly List<ArraySegment<byte>> EmptyMsgDatas =
        private static List<ArraySegment<byte>> EmptyMsgDatas =
