...
namespace Rorze.SECS.Driver
{
    public sealed class SecsGem : IDisposable
    {
        ...
        public event EventHandler<PrimaryMessageWrapper> SecondaryMessageReceived = DefaultSecondaryMessageReceived;
        private static void DefaultSecondaryMessageReceived(object sender, PrimaryMessageWrapper _) { }
        ...
        public int NewSystemId => _systemByte.New();
        ...
        internal Task<SecsMessage> SendDataMessageAsync(in SecsMessage msg, in int systembyte)
        {
            ...
            // 210107 Eason
            _taskFactory.StartNew(
                            wrapper => SecondaryMessageReceived(this, Unsafe.As<PrimaryMessageWrapper>(wrapper)),
                            new PrimaryMessageWrapper(this, header, msg));
        ...
        public Task<SecsMessage> SendAsync(SecsMessage msg,int SystemId) => SendDataMessageAsync(msg, SystemId);
        public void Dispose()
        {
